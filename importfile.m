%% IMPORT FILE FROM .csv FORMAT
function mouse1 = importFile(filename, startRow, endRow)
%==========================================================================
...
%   MOUSE1 = IMPORTFILE(FILENAME) Reads data from text file FILENAME for
%   the default selection.
%
%   MOUSE1 = IMPORTFILE(FILENAME, STARTROW, ENDROW) Reads data from rows
%   STARTROW through ENDROW of text file FILENAME.
%
% Example:
%   mouse1 = importfile('mouse1.csv', 22, 66);
%
%    See also TEXTSCAN.

% Auto-generated by MATLAB on 2017/12/05 11:19:10
